      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-[#1a1a1a] shadow-2xl flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between p-6 border-b border-white/10">
              <h2 className="text-2xl font-bold gold-text">Carrinho</h2>
            ...
            <div className="flex-grow p-6 overflow-y-auto space-y-4">
              {cartItems.length === 0 ? (
                ...
                cartItems.map(item => (
                  <div key={item.variant.id} className="flex items-center gap-4 bg-[#2a2a2a] p-3 rounded-lg">
            ...
            {cartItems.length > 0 && (
              <div className="p-6 border-t border-white/10">
                ...
                <Button onClick={handleCheckout} className="w-full bg-gradient-to-r from-[#D4AF37] to-[#F4E5B8] text-[#121212] hover:opacity-90 font-semibold py-3 text-base">
                  Finalizar Compra
                </Button>
              </div>
            )}
